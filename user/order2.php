                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form  action="add2.php" method="post">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <textarea rows="10" col="5" name="du" class="form-control" id="dob"  required></textarea>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <input type="submit" name="lb" value="SEND" class="btn btn-primary btn-lg">
                          </div>
                        </div>
                      </form>
                    </div>
