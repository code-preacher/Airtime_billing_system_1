                    ...
                    <div class="card-body">
                      <form  action="add.php" method="post">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="ct" class="form-control" id="dob"   required>
                            </div>
                          </div>
                        </div>
                        <!--/.row-->
						...
						<div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="number" maxlength="11" name="ctn" class="form-control" id="dob"   required>
                            </div>
                          </div>
                        </div>
                        <!--/.row-->
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label for="ccnumber">Call Duration (in seconds)</label>
                              <input type="number" name="du" class="form-control" id="dob"  required>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <input type="submit" name="lb" value="CALL NOW" class="btn btn-primary btn-lg">
                          </div>
                        </div>
                      </form>
                    </div>
