...
$a=$_SESSION['user'];
 ...
 $xp=$qp['bal'];
  ...
  $q = $db->prepare("select contact,contactno,duration,charge,ibalance,cbalance,date from history  where mobile='$qt'  order by id desc");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
?>
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    <div class="card-header">
                      <strong>Your Call History &nbsp;&nbsp;(&nbsp;Total number of calls : &nbsp;<?php echo $n?>&nbsp;)</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <?php if ($n > 0):
                          $q->bind_result($cn,$cno,$d,$ch,$ib,$cb,$dt);
                          $c = 1;
                      ?>
