...
mysqli_query($db,"update balance set bal='$fbal' where mobile='$qt'");	 
 mysqli_query($db,"insert into browsing (mobile,website,duration,charge,ibalance,cbalance,date) values ('$qt','$wb','$dr','$pl','$xp','$fbal','$dt')");

	 	  echo"<script>
	  alert(' You are surfing the internet ')
	  window.location='r3.php';
	  </script>";
           exit;
