...
$a=$_SESSION['user'];
 ...
 $xp=$qp['bal'];
  ...
  $q = $db->prepare("select website,duration,charge,ibalance,cbalance,date from browsing  where mobile='$qt'  order by id desc");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
?>
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    <div class="card-header">
                      <strong>Your Browsing History &nbsp;&nbsp;(&nbsp;Total number of website visited : &nbsp;<?php echo $n?>&nbsp;)</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <?php if ($n > 0):
                          $q->bind_result($cn,$d,$ch,$ib,$cb,$dt);
                          $c = 1;
                      ?>
					   <div class="form-group">
                              <label for="ccnumber">Search for Website visited</label>
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for Contact Name"  required>
                            </div>
