...
<?php 
  ...
  $q = $db->prepare("select mobile,contact,contactno,message,charge,ibalance,cbalance,date from sms    order by id desc");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
?>
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    <div class="card-header">
                      <strong>Your SMS History &nbsp;&nbsp;(&nbsp;Total number of sms : &nbsp;<?php echo $n?>&nbsp;)</strong>
                      <small></small>
                    </div>
                    <div class="card-body" >
                      <?php if ($n > 0):
                          $q->bind_result($cnum,$cn,$cno,$d,$ch,$ib,$cb,$dt);
                          $c = 1;
                      ?>
					   <div class="form-group">
                              <label for="ccnumber">Search for Customer Number</label>
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for Customer Name"  required>
                            </div>
							
							<table id="myTable">
  <tr class="header"> <th>Customer Number</th>
      <th>Contact Name</th>
