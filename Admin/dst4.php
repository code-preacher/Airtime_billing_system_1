...
<?php 
  ...
  $q = $db->prepare("select mobile,contact,contactno,duration,charge,ibalance,cbalance,date from history   order by id desc");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
?>
                ...
                <div class="col-md-8 col-md-offset-2">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <strong>Customer Call History &nbsp;&nbsp;(&nbsp;Total number of calls : &nbsp;<?php echo $n?>&nbsp;)</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <?php if ($n > 0):
                          $q->bind_result($cm,$cn,$cno,$d,$ch,$ib,$cb,$dt);
                          $c = 1;
                      ?>
                       
					   <div class="form-group">
                              <label for="ccnumber">Search for Contact</label>
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for Customer Number"  required>
                            </div>
							<table id="myTable">
  <tr class="header">
